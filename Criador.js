...
function validar(tarefa) {
    ...
    if (tarefa.titulo === "" || tarefa.titulo.length < 3) {
        ...
        document.querySelector("#titulo-error").innerText = "O nome deve ter 4 caracteres!";
        valid = false;
    }

    if (tarefa.descricao === "") {
        document.querySelector("#descricao").classList.add("is-error");
        document.querySelector("#descricao-error").innerText = "A descrição do personagem deve ter minimo 20 caracteres!";
        valid = false;
    }
